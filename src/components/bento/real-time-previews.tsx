...
const RealtimeCodingPreviews: React.FC = () => {
  ...
  style={{
    ...
    padding: "12px 16px",
    border: "1px solid var(--realtime-primary-color)",
    borderRadius: "6px",
    background: "hsl(var(--background))",
  }}
>
  <p style={{ margin: 0, fontWeight: 600, color: "var(--realtime-primary-color)" }}>
          ...
          >
            <defs>
              <linearGradient id="connectionGradient" x1="1" y1="0" x2="1" y2="285.088" gradientUnits="userSpaceOnUse">
                <stop stopColor="#189e33ff" stopOpacity="0" />
                <stop offset="0.5" stopColor="#189e33ff" />
                <stop offset="1" stopColor="#189e33ff" stopOpacity="0" />
              </linearGradient>
            </defs>
